		...
		handler: async (args: string, ctx: ExtensionCommandContext) => {
			...
			if (
				...
				const helpText = [
					...
					"  📊 % / 💰 $x.xx     — využití kontextu (zelená OK, žlutá ≥80 %, červená ≥90 %) a útrata",
					...
					"  🔌 MCP ● / 🔌 MCP ○  — MCP nástroje: ● aktivní, ○ neaktivní",
					"  💡 LSP ● / 💡 LSP ○  — LSP servery: ● aktivní, ○ neaktivní",
					"  (při šířce 8 sloupců se zkratky skryjí — jen emoji a tečky)",
					"",
					"### Příkazy:",
